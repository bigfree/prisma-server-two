...
import { TaskCreateInput, TaskUpdateInput } from "./TaskInput";
import { LabelGetPayload, PrismaClient, TaskGetPayload, UserGetPayload } from "../../prisma/client";
import { TaskFilter, TasksFilter } from "./TaskFilter";
...
export default class {
    ...
    @Authorized()
    async task(
        @Args() taskUpdateArgs: TaskFilter,
        @Ctx("prisma") prisma: PrismaClient
